        ...
        <div>
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/ph7NLBD/blog7.jpg)' }}>
                ...
                <div className="text-center  text-neutral-content">
                    <div className="">
                        <h1 className="mb-5 lg:text-5xl text-amber-600 font-bold animate__animated animate__zoomInDown">Welcome to my Blog Page</h1>
            ...
            <div className=" grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 my-7 lg:my-10" >
                {
                    blogs.map(blog => <Blog
                        key={blog.id}
                        blogs={blog}
